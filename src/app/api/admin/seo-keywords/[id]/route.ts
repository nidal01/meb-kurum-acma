...
import { deleteSeoKeyword, updateSeoKeyword } from "@/lib/blog/topic-db";
...
export async function PATCH(req: NextRequest, ctx: Ctx) {
  try {
    ...
    const body = (await req.json()) as { keyword?: string; priority?: number; active?: boolean };
    const keyword = await updateSeoKeyword(id, body);
